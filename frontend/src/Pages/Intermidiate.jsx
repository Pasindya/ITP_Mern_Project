  ...
  return (
    <div className="p-4 bg-white shadow-md rounded-lg max-w-2xl mx-auto my-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <img src="advanced-surfing.jpg" alt="Advanced Surfing" className="w-full h-48 object-cover rounded-md shadow" />
        <img src="surf-coaching.jpg" alt="Surf Coaching" className="w-full h-48 object-cover rounded-md shadow" />
        <img src="wave-dynamics.jpg" alt="Wave Dynamics" className="w-full h-48 object-cover rounded-md shadow" />
        <img src="intermediate-group.jpg" alt="Intermediate Group" className="w-full h-48 object-cover rounded-md shadow" />
      </div>
