...
export default function Home() {
  return (
    <div className="bg-white text-slate-900">
      ...
      <section className="relative h-screen bg-cover bg-center" style={{ backgroundImage: "url('/public/images/p2.jpg')" }}>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <img src="/public/images/package1.jpg" alt="Beginner Package" className="w-full h-48 object-cover" />
            <div className="p-4">
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <img src="/public/images/package2.jpg" alt="Intermediate Package" className="w-full h-48 object-cover" />
            <div className="p-4">
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <img src="/public/images/package3.jpeg" alt="Advanced Package" className="w-full h-48 object-cover" />
            <div className="p-4">
